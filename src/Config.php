...
class Config
{
    ...
    */
    public $post=['enviar_form' => __NAMESPACE__.'\FormularioController::SaveData'];
    /**
    * GET data process
    * get the get data and execute the function
    * @example ['get_data'=>'EJFORM::function']
    */
    public $get=[];
    /**
    * add_filter data functions
    * @input array
    * @example ['body_class','EJFORM::function',10,2]
    * @example ['body_class',['EJFORM','function'],10,2]
    */
    public $add_filter=[];
    /**
    ...
    * @input array
    * @example [['example','EJFORM\ExampleController::example_shortcode']]
    */
    public $shortcodes=[
        ['example','EJFORM\ExampleController::example_shortcode'],
        ['mi_formulario','EJFORM\FormularioController::form']
    ];
    /**
    * Dashboard
